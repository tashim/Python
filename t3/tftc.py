...
from tftpy.TftpPacketTypes import TftpPacketDAT

logger = logging.getLogger(__name__)

udp_port = 69
file_update_allowed_ext = ['bin', 'cfg','py']
...
class TftpUpdateClient(threading.Thread):
    ...
    def set_progress(self, pack):
        if isinstance(pack, TftpPacketDAT):
