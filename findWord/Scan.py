...
def scanPhone(text,word=""):
    ...
    ret_word = findWholeWord(word)(readytext)
    if ret_word == None :
        return None
    else:
        data["word"] = ret_word
    ...
    # print(data)
    # if data['Phone'] == '': return None
    # if len(data['Phone']) < 1: return None
    # if len(data['Phone']) < 8: return  None
    return data
